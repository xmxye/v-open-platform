    ...
    <el-dialog title="编辑终端账号" :visible.sync="editAccountDialogFormVisible">
      <el-form :model="form">
        <div style="position:relative">
          <el-form-item label="所属部门" :label-width="formLabelWidth" prop="userAccount">
            <el-input @click.native="ownDepartHandler" readonly v-model="form.userAccount" autocomplete="off"></el-input>
            <i class="el-icon-arrow-down down-icon"></i>
          </el-form-item>
           <!-- 存放所属部门的table容器 -->
          <div class="select-table-container" v-if="ownDepartIsShow">
            <!-- 查询的头部 -->
            <div class="search-container">
              <el-input v-model="inputOwnDepart" placeholder="请输入查询条件"></el-input>
              <el-button icon="el-icon-search" class="research-btn">查询</el-button>
            </div>
            <!-- 查询的内容显示区域 -->
            <div>
              <el-table
                :data="tableDataOwnDepart"
                style="width: 100%">
                <el-table-column
                  prop="date"
                  label="部门编号"
        ...
        <div style="position:relative">
          <el-form-item label="权限集" :label-width="formLabelWidth">
            <el-input @click.native="RightsHandler" readonly v-model="form.accountName" autocomplete="off"></el-input>
            <i class="el-icon-arrow-down down-icon"></i>
          </el-form-item>
           <!-- 存放所属部门的table容器 -->
          <div class="select-table-container" v-if="RightsIsShow">
            <!-- 查询的头部 -->
            <div class="search-container">
              <el-input v-model="inputOwnDepart" placeholder="请输入查询条件"></el-input>
              <el-button icon="el-icon-search" class="research-btn">查询</el-button>
        ...
        <div style="position:relative">
          <el-form-item label="特殊部门" :label-width="formLabelWidth">
            <el-input @click.native="specialDepartHandler" v-model="form.specialDepart" autocomplete="off"></el-input>
            <i class="el-icon-arrow-down down-icon"></i>
          </el-form-item>
           <!-- 存放特殊部门的table容器 -->
          <div class="select-table-container" v-if="specialDepartIsShow">
            <!-- 查询的头部 -->
            <div class="search-container">
              <el-input v-model="inputOwnDepart" placeholder="请输入查询条件"></el-input>
              <el-button icon="el-icon-search" class="research-btn">查询</el-button>
